                    ...
                    <div class="row">
                        <div class="col-xs-12 col-lg-offset-1 col-lg-10">
                            <div class="page-title text-center">
                                <h2>Serwer <span class="primary">Reallife</span> <span class="title-bg">RichLife</span>
                                </h2>
                                <p>Oferujemy mnóstwo autorskich skryptów / rozwiązań i pomysłów.</p>
                            </div>
                            ...
                            <div class="hexagon-menu services clear">
                                <div class="service-hex">
                                    ...
                                    <div class="content">
                                        ...
                                        <h4>Koparki <br> Kryptowalut</h4>
                                        <p>Możesz otworzyć<br />swoją własną wielką kopalnie kryptowalut!</p>
                                    </div>
                                </div>
                                <div class="service-hex">
                                    ...
                                    <div class="content">
                                        ...
                                        <h4>Policja</h4>
                                        <p>Zostań policjantem<br />i chroń nasze miasto przed bandytami!</p>
                                    </div>
                                </div>
                                <div class="service-hex">
                                    ...
                                    <div class="content">
                                        ...
                                        <h4>Otwórz <br> firmę</h4>
                                        <p>Udowodnij, <br />że jesteś osobą kreatywną i przedsiebiorczą!<br />Uruchom
                                            swój własny biznes!</p>
                                    </div>
                                </div>
                                <div class="service-hex">
                                    ...
                                    <div class="content">
                                        ...
                                        <h4>Zostań<br />Dealerem</h4>
                                        <p>Hodowla marihuany?<br />Ryzykowne,<br /> ale jakie przychody...
                                        </p>
                                    </div>
                                </div>
                                <div class="service-hex">
                                    ...
                                    <div class="content">
                                        ...
                                        <h4>Czarny Rynek</h4>
                                        <p>Handluj nielegalną bronią,<br /> narkotykami lub lekami.<br /> Stwórz
                                            największy
                                            nielegalny rynek na serwerze!</p>
                                    </div>
                                </div>
                            </div>
                ...
                <nav class="page-nav clear">
                    <div class="container">
                        <div class="flex flex-middle space-between">
                            <span class="prev-page"><a href="about.php" class="link">&larr; Poprzednia
                                    strona</a></span>
                            <span class="copyright hidden-xs">Copyright &copy; 2021 RichCraft.pl</span>
                            <span class="next-page"><a href="works.php" class="link">Następna strona &rarr;</a></span>
                        </div>
                    </div>
                    <!-- /.page-nav -->
                </nav>
